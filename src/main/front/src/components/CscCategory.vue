<template>
    <div>
        ...
        <div class="csc-main-side d-none d-xxl-block">
            ...
            <router-link class="fs-5 text-body text-decoration-none" id="cscside-view" to="/csc">
                <p>자주 묻는 질문</p>
            </router-link>
            <router-link class="fs-5 text-body text-decoration-none" id="csc-view-freepath" to="/csc">
                <p>이용 문의</p>
            </router-link>
        </div>
    </div>
