...
public interface QnaDAO {
	...
	public ArrayList<QnaVO> viewlist(QnaVO qnaDTO);				//게시글 전체 조회
	public int viewWrite(QnaVO qnaDTO);							//게시글 작성
	public QnaVO viewone(int num);								//게시글 상세보기
	public int viewupdate(QnaVO qnaDTO);					//게시글 수정
	public int viewdelete(int qnanum);								//게시글 삭제
	public ArrayList<QnaVO> viewsearch(QnaVO qnaDTO);			//게시글 키워드 검색
