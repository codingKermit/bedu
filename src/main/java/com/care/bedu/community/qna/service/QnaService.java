...
public interface QnaService {
	...
	public ArrayList<QnaVO> listProc(QnaVO qnaVO) throws Exception;			//게시글 리스트 5개 조회 
	...
	public HashMap<String, Object> likeUp(int num, String userName, String regId) throws Exception;	//게시글 좋아요 증가
