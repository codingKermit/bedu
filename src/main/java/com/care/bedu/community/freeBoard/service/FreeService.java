...
public interface FreeService {
	...
	//게시글 상세보기
	public FreeVO viewone(int num, String userName)throws Exception;	
	...
	//좋아요1증가
	public HashMap<String, Object> likeUp(int num, String email, String regId, String likeyn) throws Exception;	
